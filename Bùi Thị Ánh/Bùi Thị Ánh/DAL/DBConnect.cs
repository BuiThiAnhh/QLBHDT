...
namespace DAL
{
    public class DBConnect
    {
        ...
        public DataTable dt;
        string chuoikn = @"Data Source=BUIANH\MSSQLSERVER02;Initial Catalog=BuiThiAnh_Project;Integrated Security=True";
        public void ketnoi()
        {
        ...
        public int kiemtramatrunguser(string ma, string sql)
        {
            ketnoi();
            int i;
            cmd = new SqlCommand(sql, con);
        ...
        public string valuecbb(int ma, string sql)
        {
            string val = "";
            ketnoi();
            cmd = new SqlCommand(sql, con);
